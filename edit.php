            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 g-1 projects">
                <div id="project1" class="project card shadow-sm card-body mt-5">
                    <form action="edit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-text">
                            <h2>Title:</h2>
                            <input style="width:50rem; height:4rem;" type="text" name="title"
                                value="<?php echo $result['title']; ?>" placeholder="Title">
                            <br>
                            <h2>Subtext small:</h2>
                            <input style="width:50rem; height:4rem;" type="text" name="subsmall"
                                value="<?php echo $result['subtext_small']; ?>" placeholder="Subsmall">
                            <br>
                            <h2>Subtext large:</h2>
                            <input style="width:50rem; height:4rem;" type="text" name="sublarge"
                            ...
                            <br>
                            <h2>Year made:</h2>
                            <input style="width:50rem; height:4rem;" type="text" name="yearmade"
                            ...
                            <input style="width:50rem; height:4rem;" type="submit" name="submit"
                                value="Save Changes">
                        </div>
                    </form>
                </div>
